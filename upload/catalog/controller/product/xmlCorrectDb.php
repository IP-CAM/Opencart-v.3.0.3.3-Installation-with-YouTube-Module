<?php
class ControllerProductXmlCorrectDb extends Controller {
	//// product/Xml
	public function index() {
		...
		$this->load->model('catalog/xmlCorrectDb'); //nacitanie suboru 
			 $this->model_catalog_xmlCorrectDb->getXmlCorrectDb(); //spustenie funkcie z nacitaneho suboru + zobrazenie, len ak je dane prikazom.
